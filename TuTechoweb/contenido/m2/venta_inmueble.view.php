...
<!-- CONTENIDO PRINCIPAL -->
          <main>
            ...
            <a href="tutecho_map.php#venta" class="tag_mapa"><span class="fa fa-map tag_icon_map"></span>&nbsp&nbspMapa</a>
            <span class="tag_favoritos"><span class="fa fa-star tag_favoritos_star"></span>&nbspFavoritos</span>
                 ...
                 <input type="hidden" name="busqueda_casa" value="busqueda_casa">
                  ...
                  <div class="form_group form_slider">
                     ...
                     <div class="input">
                       ...
                       <input type="text" class="range_price min-<?= (round(15000*$cambio))?> max-<?= (round(2300000*$cambio))?>" value="<?= (round(250000*$cambio))?>" id="precio_busqueda_casa">
                     </div>
                  </div>
               ...
               <div class="busqueda_contenedor_interno busqueda_departamento_type" style="display:none;">
                 ...
                 <input type="hidden" name="busqueda_departamento" value="busqueda_departamento">
                  ...
                  <div class="form_group form_slider">
                     ...
                     <div class="input">
                       <label for=""><h2>Precio máximo: <span class="precio_val"></span> <span class="millon"><?= "&nbsp" . $pais_moneda['moneda']; ?></span></h2></label>
                       <input type="text" class="range_price min-<?= (round(15000*$cambio))?> max-<?= (round(2300000*$cambio))?>" value="<?= (round(250000*$cambio))?>" id="precio_busqueda_departamento">
                     </div>
                  </div>
               ...
               <div class="busqueda_contenedor_interno busqueda_local_type" style="display:none;">
                 ...
                 <input type="hidden" name="busqueda_local" value="busqueda_local">
                  ...
                  <div class="form_group form_slider">
                     ...
                     <div class="input">
                       <label for=""><h2>Precio máximo: <span class="precio_val"></span> <span class="millon"><?= "&nbsp" . $pais_moneda['moneda']; ?></span></h2></label>
                       <input type="text" class="range_price min-<?= (round(15000*$cambio))?> max-<?= (round(2300000*$cambio))?>" value="<?= (round(250000*$cambio))?>" id="precio_busqueda_local">
                     </div>
                  </div>
             ...
             <div class="busqueda_contenedor_interno busqueda_terreno_type" style="display:none;">
               ...
               <input type="hidden" name="busqueda_terreno" value="busqueda_terreno">
                ...
                <div class="form_group form_slider">
                   ...
                   <div class="input">
                     <label for=""><h2>Precio máximo: <span class="precio_val"></span> <span class="millon"><?= "&nbsp" . $pais_moneda['moneda']; ?></span></h2></label>
                     <input type="text" class="range_price min-<?= (round(15000*$cambio))?> max-<?= (round(2300000*$cambio))?>" value="<?= (round(250000*$cambio))?>" id="precio_busqueda_terreno">
                   </div>
                </div>
