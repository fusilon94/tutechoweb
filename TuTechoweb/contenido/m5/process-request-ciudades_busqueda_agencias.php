...
if(isset($_POST["departamentoChoice"])){
    ...
    $consulta_ciudades_c =	$conexion->prepare("SELECT ciudad FROM ciudades WHERE departamento=:departamento AND ciudad_poblado='c' AND agencias > 0 ORDER BY ciudad ASC");
    ...
    $consulta_ciudades_p =	$conexion->prepare("SELECT ciudad FROM ciudades WHERE departamento=:departamento AND ciudad_poblado='p' AND agencias > 0 ORDER BY ciudad ASC");
