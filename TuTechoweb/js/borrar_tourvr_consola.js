...
// SE DEFINE LA FUNCION QUE PERMITE TRAER LOS SPONSORS DE LA BASE DE DATOS #####################################
      ...
      function find_bien_inmueble(barrio_param){
            $.ajax({
                type: "POST",
                url: "process-request-tourvr-visibility.php",
              ...
              if (Object.entries(bienes_array).length > 0) {//si no es un array vacio
                ...
                $('.resultados_container').append("<span class='label_resultadors_contenedor'>Tours VR activos en: " + barrio_param + "</span>");

                bienes_array.forEach(function(bien){
                  if (bien['tourvr_visibilidad'] == 1) {
              ...
              if ($(".boton_borrador_mini_contenedor").length == 0) {
                $('.resultados_container').append("- NO EXISTEN TOURS VR QUE MOSTRAR -");
              };
          ...
          function find_bien_inmueble_by_reference(reference_param){
            $.ajax({
              ...
              if (bienes_array.length > 0) {//si no es vacio
                ...
                $('#switch_value').val('activos');
                $('.resultados_container').append("<span class='label_resultadors_contenedor'>Tours VR activos en: " + bienes_array[0]['location_tag'] + "</span>");

                  if (bienes_array[0]['tourvr_visibilidad'] == 1) {
        ...
        if ($('#switch_value').val() == 'activos') {//si estamos en activos, mostrar los sponsors activos
          ...
          if (reference_param !== '') {
            ...
            $.ajax({
              ...
              var bienes_array = data;
                      ...
                      if (Object.entries(bienes_array).length > 0) {//si no es un array vacio
                        $('.resultados_container').append("<span class='label_resultadors_contenedor'>Tours VR activos:</span>");
          ...
          if (reference_param !== '') {
            ...
            $.ajax({
              ...
              if (Object.entries(bienes_array).length > 0) {//si no es un array vacio
                $('.resultados_container').append("<span class='label_resultadors_contenedor'>Tours VR inactivos:</span>");

                bienes_array.forEach(function(bien){
                  if (bien['tourvr_visibilidad'] == 0) {
...
// ################### CODIGO PARA MOSTRAR INFO DEL BIEN INMUEBLE #####################################
    ...
    $(".resultados_container").on("click", '.boton_borrador_formulario', function(){
      ...
      $.ajax({
          type: "POST",
          url: "process-request-form-info-editar-fotos.php",
