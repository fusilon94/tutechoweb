...
$(document).ready(function(){
  jQuery(function($){
      ...
      <input type="hidden" class="popup_date" value="${date_selected}">
        ...
        <div class="contenido_tarea activo">
            ...
            <div class="botones_tarea_wrap">
              <span class="btn_cita_opcion">Cita</span>
              <span class="btn_salida_opcion">Salida</span>
            </div>

            <input type="text" class="hora_tarea" placeholder="Hora de la tarea" value="">

            <input type="text" class="tarea_descripcion" placeholder="Descripción corta:">
    ...
    $(".popup_overlay").on("click", ".botones_tarea_wrap span", function(){
      ...
      if ($(this).hasClass("btn_cita_opcion")) {
        $(".btn_salida_opcion").removeClass("activo");
        $(".btn_cita_opcion").addClass("activo");
      }else if($(this).hasClass("btn_salida_opcion")){
        $(".btn_cita_opcion").removeClass("activo");
        $(".btn_salida_opcion").addClass("activo");
      };
    ...
    $(".popup_overlay").on("input", ".tarea_descripcion", function(){
    ...
    $(".popup_overlay").on("click", ".btn_guardar_tarea", function(){
      ...
      if ($(".btn_cita_opcion").hasClass("activo")) {
        tipo_tarea = 'cita';
      }else if($(".btn_salida_opcion").hasClass("activo")){
        tipo_tarea = 'salida';
      };

      const descripcion_tarea = $(".tarea_descripcion").val();
      ...
      if (tipo_tarea == '' || descripcion_tarea == '' || hora_tarea == '') {
        ...
        $.ajax({
            ...
            data: { fecha_tag_sent: 'refresh_jefe_local', date_tag_sent : fecha_selected, tipo_tarea_sent : tipo_tarea, hora_tarea_sent : hora_tarea, descripcion_tarea_sent : descripcion_tarea, agencia_tag_sent : agencia_tag_default, agente_id_sent : agente_id_default, past_events_sent : past_event }
        }).done(function(data){
      ...
      if (fecha_selected == '' || titulo_evento == '' || tipo_evento == '' || modo_evento == '') {
        ...
        if (tipo_evento == 'check_list' && complemento == '[]') {
          ...
          $.ajax({
            type: "POST",
            url: "process-request-calendario.php",
            data: { fecha_tag_sent: 'refresh_jefe_local', modo_sent : modo_evento, date_tag_sent : fecha_selected, tipo_evento_sent : tipo_evento, hora_evento_sent : hora_evento, titulo_evento_sent : titulo_evento, complemento_sent: complemento, agencia_tag_sent : agencia_tag_default, agente_id_sent : agente_id_default, past_events_sent : past_event }
          }).done(function(data){
