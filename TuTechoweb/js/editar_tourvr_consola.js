...
// SE DEFINE LA FUNCION QUE PERMITE TRAER LOS SPONSORS DE LA BASE DE DATOS #####################################
      ...
      function find_bien_inmueble(barrio_param){
            $.ajax({
                type: "POST",
                url: "process-request-tourvr-all.php",
              ...
              if (Object.entries(bienes_array).length > 0) {//si no es un array vacio
                ...
                bienes_array.forEach(function(bien){
                  if (bien['visibilidad'] == 'visible') {
                    $('.resultados_container').append("<div class='boton_borrador_mini_contenedor'><div id='" + bien['referencia'] + "' name='" + bien['tipo_bien'] + "' class='boton_borrador_formulario'><i class='fas fa-search' aria-hidden='true'></i><p><span class='nombre'>" + bien['referencia'] + "</span></p></div><div class='boton_borrador_formulario_borrar' onclick='confirmacion(this)'><i class='fas fa-globe' aria-hidden='true'></i></div><div class='boton_borrador_formulario_borrar_confirmar' onclick='confirmacion_borrar(this)'><p>EDITAR?</p></div></div>");
                  };
                });
              ...
              if (bienes_array.length > 0) {//si no es vacio
                ...
                $('.resultados_container').append("<span class='label_resultadors_contenedor'>Bienes activos en: " + bienes_array[0]['location_tag'] + "</span>");
                  ...
                  if (bienes_array[0]['visibilidad'] == 'visible') {
                    $('.resultados_container').append("<div class='boton_borrador_mini_contenedor'><div id='" + bienes_array[0]['referencia'] + "' name='" + bienes_array[0]['tipo_bien'] + "' class='boton_borrador_formulario'><i class='fas fa-search' aria-hidden='true'></i><p><span class='nombre'>" + bienes_array[0]['referencia'] + "</span></p></div><div class='boton_borrador_formulario_borrar' onclick='confirmacion(this)'><i class='fas fa-globe' aria-hidden='true'></i></div><div class='boton_borrador_formulario_borrar_confirmar' onclick='confirmacion_borrar(this)'><p>EDITAR?</p></div></div>");
                  };
...
// ############################## SWITCH #######################################
      ...
      $('.switch_sponsors').on('click', '.switch', function(){
        ...
        if ($('#switch_value').val() == 'activos') {//si estamos en activos, mostrar los sponsors activos
            ...
            if (Object.entries(bienes_array).length > 0) {//si no es un array vacio
              $('.resultados_container').append("<span class='label_resultadors_contenedor'>Bienes activos:</span>");
            ...
            if (Object.entries(bienes_array).length > 0) {//si no es un array vacio
              $('.resultados_container').append("<span class='label_resultadors_contenedor'>Bienes inactivos:</span>");
