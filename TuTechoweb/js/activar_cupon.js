$(document).ready(function(){
  jQuery(function($){
    ...
    $(".boton_borrador_formulario_borrar_confirmar").on("click", function(){
      var cupon_activar = $(this).parent().find("div.boton_borrador_formulario").attr("id");
      var pais = $(this).parent().find("div.boton_borrador_formulario").attr("name");
      $.ajax({
          type: "POST",
          url: "process-request-cupon_activar.php",
          data: { cupon_para_activar : cupon_activar, pais_sent : pais },
      }).done(function(data){
    ...
    $(".boton_borrador_formulario").on("click", function(){
      var sponsor_cupon_nombre = $(this).attr('id');
      var pais = $(this).attr("name");

      $.ajax({
          type: "POST",
          url: "process-request-cupon_visualizar_admin.php",
          data: { cupon_sent : sponsor_cupon_nombre, pais_sent : pais  },
      }).done(function(data){
