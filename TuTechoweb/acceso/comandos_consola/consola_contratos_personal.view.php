...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Contratos Personal</title>
...
<main>
  ...
  <h1 class="titulo">Consola - Contratos Personal</h1>
  <hr class="barra">
  ...
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="contenedor_comandos_consola" id="formulario_contratos_entry" autocomplete="off">
    ...
    <div class="opciones_wrapper">
      <div class="select_tipo_wrap">
        <label for="tipo_select" class="select_label">Tipo de Personal:</label>
      ...
      <div class="select_pais_wrap">
        <label for="pais_select" class="select_label">País de contratación:</label>
