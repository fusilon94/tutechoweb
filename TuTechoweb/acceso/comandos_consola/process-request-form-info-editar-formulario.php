...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {// Verificar que se envio la solicitud por AJAX
    ...
    if (isset($_POST["referencia_sent"]) && isset($_POST["tabla_sent"])) {
      ...
      $consulta_info_form =	$conexion->prepare("SELECT estado, tipo_bien, exclusivo, anticretico, pre_venta, ultima_edicion_info, editor_info_id, pais, ciudad, departamento, barrio, direccion, direccion_complemento, propietario_nombre, propietario_apellido, propietario_telefono FROM $tabla WHERE referencia=:referencia ");
      ...
      <div class=\"previsualizacion_container\">
            <div class=\"info_adicional_container\">
              ...
              <div class=\"elemento_info_acicional\"><span class=\"info_label\">Última edición:</span><span class=\"info_text\">" . $info_form['ultima_edicion_info'] . "</span></div>
              <div class=\"elemento_info_acicional\"><span class=\"info_label\">Editor ID:</span><span class=\"info_text\">" . $info_form['editor_info_id'] . "</span></div>
