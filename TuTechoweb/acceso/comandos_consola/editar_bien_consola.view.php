...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Editar Formulario</title>
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/editar_formulario_bien_consola.js"></script>
      ...
      <script>
        function confirmacion(e){
          ...
          $(trashicon).toggleClass("fa-clipboard-list fa-times");
...
<main>
  ...
  <h1 class="titulo">Consola - Editar Formulario</h1>
  <hr class="barra">
  <p style="color: #fff; margin: 0.5em 0em 0.5em 2em;">* Solo podrán editar los Bienes-Inmuebles registrador en su agencia</p>
