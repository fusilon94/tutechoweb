...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Borrar File</title>
      ...
      <link rel="stylesheet" href="../../css/borrar_file.css">
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/borrar_file.js"></script>
...
<main>
  ...
  <h1 class="titulo">Consola - Borrar File</h1>
  <hr class="barra">

  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="contenedor_comandos_consola" id="form_borrar_file" autocomplete="off">
