...
<!-- CONTENIDO PRINCIPAL -->
<main>
  <div class="desconeccion_boton_div_contenedor">
  <a href="../cerrar_session.php">
    <span class="fas fa fa-times-circle fa-2x regreso_boton"></span>
    <span><p>Desconectarse</p></span>
  </a>
  </div>
  <?php
  ...
  ?>
  <h1 class="titulo">Consola de Usuario:<br>- <?php echo strtoupper($_SESSION['usuario']) ?> -</h1>
  <hr class="barra">

  <div class="contenedor_comandos_consola">

    <?php
    if ($nivel_acceso !== '8' && $nivel_acceso !== '9') {
      echo "
      <div class=\"comando_consola\">
        <a href=\"info_personal_consola.php\">
          <img src=\"" . $logo_genero . "\" alt=\"Informacion Personal\">
    ...
    if ($nivel_acceso == '4' || $nivel_acceso == '10') {
      echo "
      <div class=\"comando_consola\">
        <a href=\"visita_inmueble_consola.php\">
          <img src=\"" . $visita_genero . "\" alt=\"Visita Inmueble\">
          <p>Visita Inmueble</p>
        </a>
      </div>
      ";
