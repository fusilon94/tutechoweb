...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Cambiar Códigos Sponsor</title>
      ...
      <link rel="stylesheet" href="../../css/cambiar_codigos_sponsor.css">
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/cambiar_codigos_sponsor.js"></script>
      <script src="../../js/cambiar_codigos_sponsor_funciones.js"></script>
...
<main>
  ...
  <h1 class="titulo">Consola - Cambiar Códigos Sponsor</h1>

  <div class="contenedor_inactivar_sponsor_consola">

    <span class="label_select_contenedor">- Busca Sponsor(s) con códigos habilitados según Poblado o Barrio -</span>
