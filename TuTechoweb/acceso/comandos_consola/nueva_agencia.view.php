...
<meta name="theme-color" content="#ffffff">
      <title><?= (isset($_SESSION['agencia_edit']) ? 'Editar Agencia' : 'Nueva Agencia') ?></title>
...
<main>
  ...
  <h1 class="titulo">Consola - <?= (isset($_SESSION['agencia_edit']) ? 'Editar Agencia' : 'Nueva Agencia') ?></h1>
  ...
  <form id="nueva_agencia_form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="contenedor_editor_sponsor_consola">
    ...
    <span class="titulo_azul">- <?= (isset($_SESSION['agencia_edit']) ? ('Agencia de ' . $agencia_info['location_tag']) : 'Complete el formulario para crear una nueva agencia') ?> -</span>
    ...
    <div class="contenedor_consola">
      <div class="select_contenedor">
          ...
          <div class="elemento_formulario">
              ...
              onblur='this.size=0;'
              onchange='this.size=0; this.blur();' class="barrio" <?= ((isset($_SESSION['agencia_edit']) && $agencia_info['barrio'] !== '') ? '' : 'disabled') ?>>
              <?php if (isset($_SESSION['agencia_edit']) && $agencia_info['barrio'] !== ''): ?>
                <option selected><?php fill_edit_info('barrio', $agencia_info); ?></option>
              <?php endif; ?>
              </select>
