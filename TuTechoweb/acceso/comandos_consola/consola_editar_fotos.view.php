...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Completar Fotos</title>
      ...
      <link rel="stylesheet" href="../../css/consola_editar_bien_inmueble.css">
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/editar_fotos_bien_consola.js"></script>
      ...
      <script>
        function confirmacion(e){
          ...
          $(trashicon).toggleClass("fa-images fa-times");
...
<main>
  ...
  <a href="<?php if($nivel_acceso == 7){echo "consola.php";}else{echo "bien_inmueble_consola.php";}; ?>">
  ...
  <h1 class="titulo">Editar Fotografias de Bienes-Inmuebles</h1>
  <hr class="barra">
