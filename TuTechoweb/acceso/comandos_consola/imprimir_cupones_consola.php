...
if (isset($_SESSION['usuario'])) {//si una SESSION a sido definida entonces dejar pasar, si no redirigir a login.php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') { //si se envio datos por POST guardar los datos en variables que seran temporales
    ...
    if(isset($_POST['barrio_cupones_sent']) && isset($_POST['codigo'])){

      $barrio_cupones = $_POST['barrio_cupones_sent'];
      ...
      $_SESSION['cupon_barrio'] = $barrio_cupones;

      $statement = $conexion->prepare(
       "UPDATE codigos_impresion_cupones SET usado = 1, id_agente = :id_agente, fecha_uso = :fecha_uso WHERE codigo = :codigo"
      );
      ...
      header('Location: ficha_cupones_sponsor.php');
...
require 'imprimir_cupones_consola.view.php';
 ?>
