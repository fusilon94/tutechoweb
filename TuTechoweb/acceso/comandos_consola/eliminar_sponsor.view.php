...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Borrar Sponsors</title>
      ...
      <link rel="stylesheet" href="../../css/borrar_sponsor.css">
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/eliminar_sponsor.js"></script>
      <script src="../../js/eliminar_sponsor_funciones.js"></script>
...
<main>
  ...
  <h1 class="titulo">Consola - Borrar <b style="color: #f54141; text-decoration: underline; text-decoration-color: #fff;">Definitivamente</b> Sponsors</h1>
  ...
  <div class="contenedor_inactivar_sponsor_consola">
    ...
    <input type="hidden" id="new_fecha_vencimiento" name="new_fecha_vencimiento" value="">
