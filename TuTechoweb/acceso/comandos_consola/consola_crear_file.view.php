...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Crear File</title>
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/consola_crear_file.js"></script>
...
<main>
  ...
  <h1 class="titulo">Consola - Crear File</h1>
  <hr class="barra">
  ...
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="contenedor_comandos_consola" id="formulario_contratos_entry" autocomplete="off">
    ...
    <div class="opciones_wrapper">
        <div class="select_tipo_wrap">
            ...
            <option value=""></option>
            <?php 
                if ($nivel_acceso == 1 || $nivel_acceso == 11 || $nivel_acceso == 3 || $nivel_acceso == 12 || $nivel_acceso == 2) {
                    echo"
                    <option value=\"personal\">Contratos de Personal</option>
                    <option value=\"memorandums\">Memorandums</option>
                    ";
                };

                if ($nivel_acceso == 1 || $nivel_acceso == 11 || $nivel_acceso == 3 || $nivel_acceso == 12 || $nivel_acceso == 10) {
                    echo"
                  <option value=\"venta\">Contratos de Venta</option>
                  <option value=\"alquiler\">Contratos de Alquiler</option>     
                  ";
                };

                if ($nivel_acceso == 1 || $nivel_acceso == 11 || $nivel_acceso == 3 || $nivel_acceso == 12) {
                  echo"
                  <option value=\"cierre\">Contratos de Cierre</option>               
                  ";
                };
      ...
      <div class="select_tipo_wrap">
        <label for="tipo_doc_select" class="select_label">Tipo de Documento:</label>
      ...
      <div class="select_pais_wrap">
        ...
        <select name="pais_select" class="pais_select" id="pais_select">
          ...
          <?php
            ...
            }elseif ($nivel_acceso == 3 || $nivel_acceso == 2 || $nivel_acceso == 10) {
              echo"
