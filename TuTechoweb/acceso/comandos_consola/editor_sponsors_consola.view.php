...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Editor Sponsors</title>
      ...
      <link rel="stylesheet" href="../../css/editor_sponsor_consola.css">
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/editor_sponsor_consola.js"></script>
...
<main>
  ...
  <h1 class="titulo">Consola - Editor Sponsors</h1>

  <div class="contenedor_editor_sponsor_consola">

    <span class="label_select_contenedor">- Busca Sponsor(s) según Poblado o Barrio -</span>
  ...
  <form id="editor_form" autocomplete="off" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
    <input type="hidden" id="editor_sponsor_nombre" name="editor_sponsor_nombre" value="">
  </form>
