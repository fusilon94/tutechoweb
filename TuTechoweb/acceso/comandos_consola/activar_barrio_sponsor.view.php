...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Activar Barrio/Poblado</title>
      ...
      <link rel="stylesheet" href="../../css/activar_barrio_sponsor.css">
      ...
      <script src="../../js/activar_barrio_sponsor.js"></script>
...
<main>
  ...
  <h1 class="titulo">Activar Sponsors en Barrio/Poblado</h1>
  <hr class="barra">

    <div class="contenedor_inactivar_sponsor_consola">

      <span class="label_select_contenedor">- Busca Barrio o Poblado que activar -</span>
      ...
      <input type="hidden" id="barrio_tipo_input" name="barrio_tipo_input" value="">
