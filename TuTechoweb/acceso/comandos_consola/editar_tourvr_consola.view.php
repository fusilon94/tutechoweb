...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Editar Tour VR</title>
      ...
      <link rel="stylesheet" href="../../css/editar_tourvr_consola.css">
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/editar_tourvr_consola.js"></script>
      ...
      <script>
        function confirmacion_borrar(e){
                  ...
                  $("#bien_referencia").val(nuevo_formulario_referencia);
                  $("#bien_tabla").val(nuevo_formulario_tabla);
                  $("#bien_form").submit();
        }
      </script>
...
<main>
  ...
  <h1 class="titulo">Editar Tour VR - Consola</h1>
  <hr class="barra">
  ...
  <p style="color: #fff; margin: 0.5em 0em 0.5em 2em;">* Para editar bienes Activos, se requiere autorizacion</p>
  ...
  <form id="bien_form" autocomplete="off" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
    <input type="hidden" id="bien_referencia" name="bien_referencia" value="">
    <input type="hidden" id="bien_tabla" name="bien_tabla" value="">
  </form>
