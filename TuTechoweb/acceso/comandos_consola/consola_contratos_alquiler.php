...
if (isset($_SESSION['usuario'])) {//si una SESSION a sido definida entonces dejar pasar, si no redirigir a login.php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $tipo_selected = filter_var(strtolower($_POST['tipo_select']), FILTER_SANITIZE_STRING);
    ...
    $_SESSION['sub_tipo_selected'] = 'alquiler_';
...
require 'consola_contratos_alquiler.view.php';
 ?>
