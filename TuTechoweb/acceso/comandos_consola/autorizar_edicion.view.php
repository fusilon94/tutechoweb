...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Autorizar Edicion</title>
      ...
      <link rel="stylesheet" href="../../css/autorizar_edicion.css">
      <link rel="stylesheet" href="../../css/ficha_bien_autorizar_edicion.css">
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/autorizar_edicion.js"></script>
      <script src="../../js/popup_ficha_bien_autorizar_edicion.js"></script>
...
<main>
  ...
  <div class="popup_activacion">
    ...
    <h3>- Elija que autorizacion(es) de edición desea otorgar -</h3>
    <div class="botones_choices">

    </div>
    <span class="btn_autorizar">Enviar Autorizacion(es)</span>
  </div>

  <h1 class="titulo">Consola - Autorizar Edicion</h1>
  <hr class="barra">
