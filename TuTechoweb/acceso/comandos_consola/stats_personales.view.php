...
<meta name="theme-color" content="#ffffff">
      ...
      <script src="../../js/consola_stats.js"></script>
 ...
 <div id="fondo"></div>
    ...
    <div id="contenedor_total">
        ...
        <div class="graph_consola">
            ...
            <div class="tabs_wrap">
              <span class="tab tab_lista">
                <i class="fas fa-list-ul"></i>
                <p>Lista</p>
              </span>
              <span class="tab tab_graph activo">
            ...
            <div class="tab_content_graph activo">
                ...
                <div class="sub_categorias_wrap">
                  <span class="sub_categorie_btn activo">
                    <img src="" alt="">
                    <p></p>
                  </span>
                  <span class="sub_categorie_btn">
                    <img src="" alt="">
                    <p></p>
                  </span>
                  <span class="sub_categorie_btn">
