...
if (isset($_SESSION['usuario'])) {//si una SESSION a sido definida entonces dejar pasar, si no redirigir a login.php
  ...
  if (isset($_POST['cupon_agregar_nombre'])) {
    $_SESSION['nuevo_cupon'] = $_POST['cupon_agregar_nombre'];
    header('Location: registro_cupon_sponsor.php');
  };
...
require 'registro_cupon_consola.view.php';
 ?>
