...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/configuracion_formulario_departamento.js"></script>
...
<!-- CONTENIDO PRINCIPAL -->
          <main>
            ...
            <h1 class="titulo_formulario">Formulario De Registro para departamentos</h1>
  ...
  <!-- PANEL MAPA -->
   ...
   <!-- PANEL 4 -->
    ...
    <!-- PANEL 5 -->
              ...
              <div class="elemento_formulario_bien">
                <label for="tipo_departamento"><span class="fas fa-star"></span> Tipo departamento: </label>
                <select name="tipo_departamento" id="tipo_departamento" class="campo_req panel_5">
                  <?php if ($info_bien_all['tipo_departamento'] != ''): ?>
                    <option selected='selected'><?php echo $info_bien_all['tipo_departamento']; ?></option>
                  <?php endif; ?>
                  <option></option>
                  <option>Habitación/espacio compartido</option>
                  <option>Estudio</option>
                  <option>Oficina</option>
                  <option>Símplex</option>
                  <option>Dúplex</option>
                  <option>Tríplex</option>
                  <option>Quadruplex</option>
                </select>
              </div>

              <div class="elemento_formulario_bien checkbox_container">
                <input type="hidden" name="planta_baja" value="0">
                <input type="checkbox" name="planta_baja" id="planta_baja" value="1" <?php if ($info_bien_all['planta_baja'] == 1) {echo "checked";} ?>>
                <label for="planta_baja">Planta Baja </label>
              </div>

              <div class="elemento_formulario_bien checkbox_container">
                <input type="hidden" name="penthouse" value="0">
                <input type="checkbox" name="penthouse" id="penthouse" value="1" <?php if ($info_bien_all['penthouse'] == 1) {echo "checked";} ?>>
  ...
  <!-- PANEL 9 -->
              <h3 id="panel_9">Datos del Edificio <i class="fas fa-circle"></i></h3>
