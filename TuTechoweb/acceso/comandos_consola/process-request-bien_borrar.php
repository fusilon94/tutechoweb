...
if(isset($_POST["referencia_para_borrar"])){
    ...
    $update_borrar_bien =	$conexion->prepare("UPDATE $tipo_bien SET estado = :estado, visibilidad = :visibilidad WHERE referencia = :referencia");
    $update_borrar_bien->execute(array(':estado' => 'borrado', 'visibilidad' => 'no_visible', ':referencia' => $referencia_para_borrar));
