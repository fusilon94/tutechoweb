...
<meta name="theme-color" content="#ffffff">
      ...
      <script src="../../js/modificar_file_consola.js"></script>
...
<main>
  ...
  <h1 class="titulo">Consola - Modificar Files</h1>
  <hr class="barra">
  ...
  <div class="contenedor_borradores">
    ...
    foreach ($files_agentes as $files_agente) {
      echo "
      <div class=\"boton_file\" id=\"" . $files_agente['id'] . "\" name=\"" . $files_agente['cargo'] . "\" data=\"" . $files_agente['pais'] . "\" data2=\"personal\">
        <div id=\"" . $files_agente['id'] . "\" class=\"boton_borrador_formulario\">
          <i class=\"far fa-edit\" aria-hidden=\"true\"></i><p><span class='nombre'>" . $files_agente['id'] . " - " . $files_agente['cargo'] . "<br>" . strtoupper($files_agente['pais']) . "</span></p>
        </div>
      </div>
    ...
    foreach ($files_inmuebles as $files_inmueble) {
      echo "
      <div class=\"boton_file\" id=\"" . $files_inmueble['referencia'] . "\" name=\"inmueble\" data=\"" . $files_inmueble['pais'] . "\" data2=\"" . strtolower(str_replace("En ","",$files_inmueble['estado'])) . "\">
        <div id=\"" . $files_inmueble['referencia'] . "\" class=\"boton_borrador_formulario\">
          <i class=\"far fa-edit\" aria-hidden=\"true\"></i><p><span class='nombre'>" . $files_inmueble['referencia'] . " - " . ucfirst($files_inmueble['tipo_bien']) . "<br>" . strtoupper($files_inmueble['pais']) . " - " . ucfirst($files_inmueble['ciudad']) . "</span></p>
        </div>
      </div>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="formulario" name="open_file" id="open_file" autocomplete="off">
    ...
    <input type="hidden" name="tipo_doc_selected" id="tipo_doc_selected" value="">
