...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Re/Inactivar Bien Inmueble</title>
      ...
      <link rel="stylesheet" href="../../css/inactivar_bien_consola.css">
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/inactivar_bien_consola.js"></script>
      ...
      <script>
        function confirmacion_borrar(e){
                  ...
                  $.ajax({
                      type: "POST",
                      url: "process-request-bien-inmueble-inactivar-reactivar.php",
                  ...
                  $('.popup_success_text').html('Bien Inmueble Inactivado exitosamente');
        }
        ...
        function confirmacion_reactivar(e){
                  ...
                  $('.popup_success').css('visibility',  'visible');
                  $('.popup_success_text').html("Bien Inmueble Reactivado Exitosamente");
        }
      </script>
...
<main>
  ...
  <h1 class="titulo">Inactivar/Reactivar Bien Inmueble - Consola</h1>
  <hr class="barra">
  <p style="color: #fff; margin: 0.5em 0em 0.5em 2em;">* Solo podrán acceder a los Bienes-Inmuebles registrados en su agencia</p>
  <p style="color: #fff; margin: 0.5em 0em 0.5em 2em;">* Solo apareceran los Bienes autorizados para ser reactivados o inactivados</p>
