...
// REQUEST ALL INFO OF THE THUMBNAIL'S REFERENCE CLICKED AND CREATE THE CORRESPONDING POPUP_FICHA_BIEN TO BE SHOWN
    ...
    if (isset($_POST["ficha_bien_requested"]) && isset($_POST["ficha_bien_tipo_requested"]) && isset($_POST["estado"]) && isset($_POST["pais_sent"])) {
      ...
      $consulta_pais_moneda->execute(['pais' => $pais]);//SE PASA LA REFERENCIA
      ...
      $fotos_360_path = '..\..\bienes_inmuebles' . "\\" . $pais . "\\" . $ficha_bien_requested . '\\' . 'fotos_360';
      ...
      $json_fotos_path = '..\..\bienes_inmuebles' . "\\" . $pais . "\\" . $ficha_bien_requested . '\\' . 'fotos.json';
      $fotos_json = [];
      if (file_exists($json_fotos_path)) {
        $fotos_json = json_decode(file_get_contents($json_fotos_path), true);
      };

      $json_vr_path = '..\..\bienes_inmuebles' . "\\" . $pais . "\\" . $ficha_bien_requested . '\\' . 'VR.json';
      $tour_vr_json = [];
      if (file_exists($json_vr_path)) {
      ...
      $consulta_info_agencia =	$conexion->prepare("SELECT location_tag, departamento FROM agencias WHERE id=:id ");
      $consulta_info_agencia->execute([':id' => $info_ficha_bien['agencia_registro_id']]);
      $info_agencia = $consulta_info_agencia->fetch(PDO::FETCH_ASSOC);
      // CONSTRUCCION DEL POPUP DE LA FICHA BIEN SELECTED
      echo json_encode($info_agencia);

      echo "<div class=\"ficha_nav\">
            <div class=\"tabs_container\">
              <span name=\"ficha_bien\" class=\"elemento_tab active\">Ficha Bien</span>
              <span name=\"contrato\" class=\"elemento_tab\">Contrato</span>
            </div>
          ...
          <div id=\"contrato\" class=\"elemento_ficha ficha_contrato\">
            <object data=\"../../bienes_inmuebles/" . $pais . "/" . urlencode($info_ficha_bien['referencia']) . "/contrato.pdf\" type=\"application/pdf\" style=\"width:100%;height:80vh;\">
                alt : <span class=\"contrato_no_disponible\">CONTRATO NO DISPONIBLE</span>
            </object>
          </div>
          <div id=\"ficha_bien\" class=\"elemento_ficha ficha_contenido active\">
          ...
          <div id=\"bien_individual_slider\" class=\"flexslider bien_individual_slider\" style=\"margin: 3em auto 0em auto\">
            ...
            foreach ($fotos_json as $titulo => $foto) {
              echo "
              <li data-thumb=\"../../bienes_inmuebles/" . $pais . "/" . urlencode($info_ficha_bien['referencia']) . "/fotos" . "/" . $foto . "\">
                <img src=\"../../bienes_inmuebles/" . $pais . "/" . urlencode($info_ficha_bien['referencia']) . "/fotos" . "/" . $foto . "?=" . Date('U') . "\" alt=\"" . $titulo . "\">
        ...
        if ($tipo_bien_requested == 'terreno') {
          ...
          <div class=\"caracteristicas_column2\">
            ...
            <div class=\"ficha_contenido_info_extra\">
              <div class=\"extras_container\">
                <h2>Información Adicional</h2>
                <div class=\"elemento_info_adicional_barrio\"><span class=\"info_label\">Propietario:</span><span class=\"info_text\">" . $info_ficha_bien['propietario_nombre'] . $info_ficha_bien['propietario_apellido'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Telefono:</span><span class=\"info_text\">" . $info_ficha_bien['propietario_telefono'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Email:</span><span class=\"info_text\">" . $info_ficha_bien['propietario_email'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Direccion:</span><span class=\"info_text\">" . $info_ficha_bien['propietario_direccion'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Documento Identidad:</span><span class=\"info_text\">" . $info_ficha_bien['propietario_carnet'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Jefe Agencia ID:</span><span class=\"info_text\">" . $info_ficha_bien['jefe_agencia_id'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Agencia ID:</span><span class=\"info_text\">" . $info_ficha_bien['agencia_registro_id'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Registrado ID:</span><span class=\"info_text\">" . $info_ficha_bien['registrador_id'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Fecha Registro:</span><span class=\"info_text\">" . $info_ficha_bien['fecha_registro'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Fotografo:</span><span class=\"info_text\">" . $info_ficha_bien['fotografo_id'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Fecha r/Fotos:</span><span class=\"info_text\">" . $info_ficha_bien['fecha_validacion_fotografo'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Última edición info:</span><span class=\"info_text\">" . $info_ficha_bien['ultima_edicion_info'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Editor info:</span><span class=\"info_text\">" . $info_ficha_bien['editor_info_id'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Última edición fotos:</span><span class=\"info_text\">" . $info_ficha_bien['ultima_edicion_fotos'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Editor fotos:</span><span class=\"info_text\">" . $info_ficha_bien['editor_fotos_id'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Creador Tour VR:</span><span class=\"info_text\">" . $info_ficha_bien['creador_tourvr'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Fecha creación:</span><span class=\"info_text\">" . $info_ficha_bien['fecha_creacion_tourvr'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Última edición Tour VR:</span><span class=\"info_text\">" . $info_ficha_bien['ultima_edicion_tourvr'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Editor Tour VR:</span><span class=\"info_text\">" . $info_ficha_bien['editor_tourvr_id'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Fecha de Cierre:</span><span class=\"info_text\">" . $info_ficha_bien['fecha_venta'] . "</span></div>
                <div class=\"elemento_info_adicional\"><span class=\"info_label\">Cierre Agente:</span><span class=\"info_text\">" . $info_ficha_bien['vendedor_id'] . "</span></div>
                <h2>Comentarios Registrados</h2>
                <div class=\"elemento_info_adicional_barrio\">" . $info_ficha_bien['comentarios_bien'] . "</div>
              </div>
            </div>";
          ...
          <script src=\"../../js/abrir_360_viewer_detalle_inmueble.js\"></script>
      ";
