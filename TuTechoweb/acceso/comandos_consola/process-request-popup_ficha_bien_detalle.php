...
// REQUEST ALL INFO OF THE THUMBNAIL'S REFERENCE CLICKED AND CREATE THE CORRESPONDING POPUP_FICHA_BIEN TO BE SHOWN
    ...
    if (isset($_POST["ficha_bien_requested"]) && isset($_POST["ficha_bien_tipo_requested"]) && isset($_POST["estado"]) && isset($_POST["agente_sent"])) {
      ...
      $consulta_agente = $conexion->prepare("SELECT nivel_acceso FROM agentes WHERE usuario = :usuario");
      $consulta_agente->execute([":usuario" => $usuario]);
      $agente_acceso = $consulta_agente->fetch(PDO::FETCH_ASSOC);
      ...
      $consulta_info_agencia =	$conexion->prepare("SELECT departamento, location_tag FROM agencias WHERE id=:id ");
    ...
    echo"<div id=\"ficha_bien\" class=\"elemento_ficha ficha_contenido active\">
        ...
        if ($tipo_bien_requested == 'terreno') {
          ...
          <div class=\"caracteristicas_column2\">
            ...
            if (strpos('1,2,3', $agente_acceso['nivel_acceso']) !== false) {
              echo "<div class=\"ficha_contenido_info_extra\">
