...
<meta name="theme-color" content="#ffffff">
      ...
      <link rel="stylesheet" href="../../css/horario_agencia.css">
      ...
      <script src="../../js/horario_agencia.js"></script>
...
<main>
  ...
  <h1 class="titulo">Consola - Horarios Agencia</h1>

  <div class="contenedor_editor_sponsor_consola">

    <span class="label_select_contenedor"><?php if(isset($agencias)){echo "- Selecciona una Agencia -";}else{echo "- Tu Agencia -";}; ?></span>
    ...
    <?php else: ?>
      ...
      <div class="agencia_select_container">
        ...
        <select name="agencia" id="agencia" class="agencia">
          <option></option>
          <option value="<?= $agencia_especifica['id']; ?>"><?= ucfirst($agencia_especifica['location_tag']) . " (id: #" . $agencia_especifica['id'] . ")"; ?></option>
        </select>
      </div>
