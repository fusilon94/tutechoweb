  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($modo == 'first_entry') {
      ...
      $statement = $conexion->prepare(
       "INSERT INTO agencias (id, departamento, ciudad, location_tag, direccion, direccion_complemento, telefono, NIT, mapa_coordenada_lat, mapa_coordenada_lng, mapa_zoom, express) VALUES (:id, :departamento, :ciudad, :location_tag, :direccion, :direccion_complemento, :telefono, :NIT, :mapa_coordenada_lat, :mapa_coordenada_lng, :mapa_zoom, :express)"
      );
      ...
      $_SESSION['exito_bien_registrado'] = 'Agencia Express creada exitosamente';
    };
    ...
    if ($modo == 'edicion') {
      ...
      $statement = $conexion->prepare(
       "UPDATE agencias SET express = :express, departamento = :departamento, ciudad = :ciudad, location_tag = :location_tag, direccion = :direccion, direccion_complemento = :direccion_complemento, telefono = :telefono, NIT = :NIT, mapa_coordenada_lat = :mapa_coordenada_lat, mapa_coordenada_lng = :mapa_coordenada_lng, mapa_zoom = :mapa_zoom WHERE id = :id"
      );
      ...
      $_SESSION['exito_bien_registrado'] = 'Agencia Express editada exitosamente';
    };
...
require 'nueva_agencia_express.view.php';
 ?>
