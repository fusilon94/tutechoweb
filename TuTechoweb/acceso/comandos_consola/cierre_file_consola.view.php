...
<meta name="theme-color" content="#ffffff">
      <title>Consola - Cierre File</title>
      ...
      <link rel="stylesheet" href="../../css/cierre_file_consola.css">
...
<script src="../../js/menu.js"></script>
      ...
      <script src="../../js/cierre_file_consola.js"></script>
...
<main>
  ...
  <h1 class="titulo">Consola - Cierre File</h1>
  <hr class="barra">

  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="contenedor_comandos_consola" id="form_cierre_file" autocomplete="off">
      ...
      <div class="select_pais_wrap">
          ...
          <select name="pais_select" class="pais_select" id="pais_select">
            ...
            <?php
                ...
                }elseif ($nivel_acceso == 3 || $nivel_acceso == 10) {
                echo"
                    <option value=\"" . $_COOKIE['tutechopais'] . "\">" . ucfirst($_COOKIE['tutechopais']) . "</option>
                ";
                };
        ...
        <div class="select_tipo_wrap">
            <label for="tipo_file_select" class="select_label">Tipo de Cierre:</label>
            <select name="tipo_file_select" class="tipo_file_select" id="tipo_file_select">
              <option value=""></option>
              <option value="anulacion">Anulación del Servicio</option>
              <option value="cierre">Cierre Intermediación</option>
            </select>
        </div>
      <div class="select_tipo_wrap">
        <label for="id_file" class="select_label">Id File:</label>
        <input type="text" class='id_file_input' name="id_file" id="id_file" placeholder='#C3726F'>
